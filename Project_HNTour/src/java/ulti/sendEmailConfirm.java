...
public class sendEmailConfirm {
    ...
    public boolean sendMailConfirm(String email, String nametour, Date ngaydi, String messageEmail) throws UnsupportedEncodingException {
...
"        <p>Th? C?m ?n và Chu?n B? cho Chuy?n ?i T?i<br><br>" +
"        Kính g?i Quý Khách hàng yêu quý,<br><br>" +
"        Chúng tôi xin g?i l?i c?m ?n chân thành nh?t t?i Quý v? ?ã l?a ch?n và ??t hàng t?i HaNoiTour! Chúng tôi r?t vui m?ng thông báo r?ng ??n ??t hàng c?a Quý v? ?ã ???c xác nh?n thành công và chúng tôi ?ã b?t ??u chu?n b? m?i th? ?? ??m b?o chuy?n ?i c?a Quý v? tr? thành m?t tr?i nghi?m không th? quên.<br><br>" +
"        D??i ?ây là m?t s? thông tin quan tr?ng và l?ch trình chu?n b? cho chuy?n ?i c?a Quý v?:<br><br>" +
"        ??a ?i?m t?p trung: ??i h?c FPT<br>" +
"        Ngày B?t ??u Chuy?n ?i: " + ngaydi + "<br>" +
"        Ngày K?t Thúc Chuy?n ?i:" + ngaydi + "<br><br>" +
"        L?ch Trình Chu?n B?:<br><br>" +
"        1. Ki?m tra và xác nh?n l?i thông tin v? chuy?n ?i.<br>" +
"        2. L?p danh sách các ho?t ??ng và ??a ?i?m mà b?n mu?n tr?i nghi?m trong chuy?n ?i c?a mình.<br>" +
"        3. Liên h? và xác nh?n v?i h??ng d?n viên du l?ch ho?c nhân viên c?a chúng tôi ?? bi?t thêm thông tin chi ti?t v? chuy?n ?i.<br><br>" +
"        Chúng tôi mu?n ??m b?o r?ng m?i ?i?u ki?n ?ã ???c chu?n b? hoàn h?o ?? mang l?i tr?i nghi?m du l?ch t?t nh?t cho Quý v?. N?u Quý v? có b?t k? câu h?i ho?c yêu c?u ??c bi?t nào, ??ng ng?n ng?i liên h? v?i chúng tôi b?t c? lúc nào. Chúng tôi luôn s?n lòng h? tr? và ??m b?o chuy?n ?i c?a Quý v? tr? nên hoàn h?o nh?t.<br><br>" +
                    
"<strong>Ngoài ra, chúng tôi mu?n chia s? m?t s? l?u ý quan tr?ng v? các ngày l? T?t và tác ??ng c?a chúng ??i v?i giá tour:</strong><br>" +
"Trong th?i gian các ngày l? T?t, nh? T?t Nguyên ?án, Gi? T? Hùng V??ng và nhi?u ngày l? khác, giá tour có th? t?ng cao do s? t?ng c??ng trong nhu c?u du l?ch và chi phí ho?t ??ng.<br>" +
"??i v?i các ngày này, vi?c ??t tour tr??c s? giúp b?n ??m b?o ???c v? trí và d?ch v? t?t nh?t c?ng nh? tránh ???c các bi?n ??ng giá không mong mu?n.<br>" +
"Chúng tôi khuy?n khích Quý v? lên k? ho?ch s?m và ??t tour tr??c ít nh?t 1 tháng tr??c ngày kh?i hành ?? có ???c m?c giá t?t nh?t và s? ??m b?o v? d?ch v?.<br><br><br>"+
"        M?t l?n n?a, chúng tôi xin bày t? lòng bi?t ?n sâu s?c v? s? tin t??ng và l?a ch?n c?a Quý v?. Chúng tôi r?t mong ??i ???c ph?c v? và chúc Quý v? có m?t chuy?n ?i tuy?t v?i và ?áng nh?!<br><br>" +
"        Trân tr?ng,<br>" +
"        [HaNoiTour]</p>" +
"    </td>" +
"</tr>\n"
                    ...
                    + "                                                                                                                    <p style=\"line-height: 200%; color: #ffffff;\">Liên h?:</p>\n"
                    ...
                    + "                                                                                                                    <p style=\"line-height: 200%; color: #ffffff;\">??a ch?: Khu Công Ngh? Cao Hòa L?c, Km29 ??i l? Th?ng Long, Th?ch Hoà, Th?ch Th?t, Hà N?i</p>\n"
                    + "                                                                                                                </td>\n"
                    + "                                                                                                            </tr>\n"
                    + "                                                                                                        </tbody>\n"
                    + "                                                                                                    </table>\n"
...
//            }
            ...
            message.setSubject(MimeUtility.encodeText("Hà N?i Tour", "UTF-8", "B"));
    ...
    public boolean sendMailForBuy(String email, int randomNumber, String messageEmail) throws UnsupportedEncodingException {
        ...
        try {
            String emailContent = "Hà N?i Tour\n"
                    + "\n"
                    + "Kính g?i: Quý khách\n"
                    + messageEmail + "\n"
                    + "Quý khách ?ã ??t mua thành công chuy?n tour :\n"
                    + "\t\t\t\t\t\t" + randomNumber + "\n"
                    + "Hà N?i Tour hân h?nh ???c ph?c v? Quý khách.\n"
                    + "Trân tr?ng!";
