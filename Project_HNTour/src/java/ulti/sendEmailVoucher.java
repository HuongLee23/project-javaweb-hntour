 ...
 * @author Admin
 */
public class sendEmailVoucher {
     public boolean sendMailVoucher(String email, String code,int discountPercentage, String messageEmail) throws UnsupportedEncodingException {
...
"        <p>Th? C?m ?n<br>" +
"        - Mã Voucher: "+code+"<br> " +
"          - Giá tr?: "+discountPercentage+"<br>" +
      
"        Voucher c?a b?n có th? ???c s? d?ng ?? mua các s?n ph?m ho?c d?ch v? t?i c?a hàng tr?c tuy?n ho?c c?a hàng v?t lý c?a chúng tôi. Hãy s? d?ng mã voucher trên ?? nh?n ?u ?ãi t??ng ?ng.<br>" +

"N?u b?n có b?t k? câu h?i ho?c c?n h? tr?, vui lòng liên h? v?i chúng tôi qua email [vntraveltouring@gmail.com] ho?c s? ?i?n tho?i [0928008008].<br>" +

"Chúc b?n m?t ngày tuy?t v?i và thú v? v?i voucher c?a mình!<br><br>" +
"        Trân tr?ng,<br>" +
"       [HaNoiTour]</p>" +
"   </td>" +
"</tr>\n"
    ...
    public boolean sendMailForBuy(String email, int randomNumber, String messageEmail) throws UnsupportedEncodingException {
        ...
        try {
            String emailContent = "Hà N?i Tour\n"
                    ...
                    + "Kính g?i: Quý khách\n"
                    + messageEmail + "\n"
                    + "Quý khách vui lòng nh?p l?i mã xác minh sau:\n"
                    + "\t\t\t\t\t\t" + randomNumber + "\n"
