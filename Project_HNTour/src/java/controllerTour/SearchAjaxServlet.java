...
public class SearchAjaxServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Tour tour : list) {
            ...
            out.println("                <div style=\"background-color: #ee4d2d;\" class=\"button book_button\"><a href=\"fillinformationbuyer?id=" + tour.getId() + "\">Mua ngay<span></span><span></span><span></span></a></div>");
