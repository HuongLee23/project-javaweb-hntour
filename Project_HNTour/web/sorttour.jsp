<%-- 
    Document   : sorttour
    Created on : Jan 21, 2024, 1:46:10 AM
    Author     : admin
--%>
                                ...
                                <div class="offers_sorting_container">
                                    <ul class="offers_sorting">
                                        <li>
                                            ...
                                            <ul>
                                                <li class="sort_btn" data-isotope-option="{ &quot;sortBy&quot;: &quot;original-order&quot; }" data-parent=".price_sorting"><span>ascending</span></li>
...
<!--                              -->
                                    <c:forEach items="${requestScope.prod}" var="o"> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-1680-4">
                                                <div class="offers_image_container">
                                                    ...
                                                    <img class="card-img-top" src="${o.imgMain}">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="offers_content">
                                                    <div class="offers_price">${o.name}<span>About ${o.intendedTime}</span></div>
                                                    <p class="offers_text">${o.description}</p>
