<%-- 
    Document   : ProfileSupllier
    Created on : Jan 31, 2024, 12:18:40 AM
    Author     : Admin
--%>
        ...
        <div class="container">
                    ...
                    <div class="card p-3">
                        <div class="e-navlist e-navlist--active-bg">
                            <ul class="nav">
                                ...
                                <li class="nav-item"><a class="nav-link px-2" href="managertourimage"><i class="fa fa-fw fa-cog mr-1"></i><span>Manager Tour(Image)</span></a></li>
                                <li class="nav-item"><a class="nav-link px-2" href="managertourcategory"><i class="fa fa-fw fa-cog mr-1"></i><span>Manager Tour(Category)</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <script>
                ...
                function redirectToOtherPage() {
                    window.location.href = "managertourlist";
                }
            </script>
        </div>  
    </body>
